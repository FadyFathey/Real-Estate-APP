...
const CreateListing = () => {
  ...
  const onChange = () => {};
  return (
    <main className="max-w-sm  px-2 mx-auto ">
      ...
      <form>
        ...
        <input
          ...
          minLength={10}
          required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6"
        ></input>
        <div>
